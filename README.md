...
The detailed README from the CRA scaffold can be found in [README.cra.md](./README.cra.md)

#### Available Scripts

```
$ npm start       // Runs app in develop mode (default port: 3000)
$ npm test        // Launches test runner in interactive mode
$ npm run build   // Creates production app in build/ folder
$ npm run eject   // Strips build deps, creates self-contained config
```
...
After initializing both Firebase and React sides of the app, the folder structure should be as follows:
